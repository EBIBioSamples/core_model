 ...
 *
 */
public abstract class AbstractDbSchemaEnhancer implements DbSchemaEnhancer
{
	...
	protected void index ( String indexName, String tableName, String colName, Set<String> alreadyDone ) 
	{
		...
		long idxCt = ((BigDecimal) em.createNativeQuery ( 
		...
		List<BigDecimal> idxColCt = em.createNativeQuery ( 
